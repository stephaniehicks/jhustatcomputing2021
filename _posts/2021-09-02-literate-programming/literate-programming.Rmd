...
```{r missionaccomplished, echo = FALSE, out.width='30%', fig.cap = "Mission accomplished!"}
...
```{r hex-blogdown, echo = FALSE, out.width = '10%', fig.cap = "blogdown logo"}
...
```{r hex-bookdown, echo = FALSE, out.width='70%', fig.cap = "blogdown logo"}
