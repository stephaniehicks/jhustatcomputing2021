...
This class is not designed to teach the theoretical aspects of statistical or computational methods, but rather the goal is to help with the practical issues related to creating R packages implementing these methods, conducting reproducible data analyses, best practices for data visualization and writing code, and creating websites for personal or project use. 
...
3. Click on "Download R 4.0.2 for Windows"


![Video Demo for Downloading R for Windows](video/downloadRWindows.gif)
...
2. Click on "R-4.0.2.pkg"


![Video Demo for Downloading R for the Mac](video/downloadRMac.gif)
...
![Video Demo for Downloading RStudio](video/downloadRStudio.gif)
