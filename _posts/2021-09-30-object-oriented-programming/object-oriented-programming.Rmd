...
including Java, Ruby, Python, and C++. Base R has three object oriented systems
...
which is a **function** that is associated with a particular class. We will be
...
Now it is time to wade into some of the quirks of R's object oriented systems. In
...
OK back to the print method for the polygon class: 
...
method as a string, the method signature which specifies the class of each
