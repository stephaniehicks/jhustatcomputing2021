...
1. https://r-pkgs.org
2. https://stat545.com/package-overview.html
...
```{r new-project, echo=FALSE, fig.cap='A screenshot of starting a New Project in R', fig.align='center'}
...
```{r new-dir, echo=FALSE, fig.cap='A screenshot of starting a New Directory for a New Project in R', fig.align='center'}
...
```{r use-devtools, echo=FALSE, fig.cap='Create a R package using devtools', fig.align='center'}
...
```{r pkg-name, echo=FALSE, fig.cap='Package name', fig.align='center'}
...
```{r build-menue, echo=FALSE, fig.cap='Build menu', fig.align='center'}
...
```{r config-build-tools, echo=FALSE, fig.cap='Configure Build tools', fig.align='center'}
...
```{r config-button, echo=FALSE, fig.cap='Click the Configure button', fig.align='center'}
...
```{r install-restart, echo=FALSE, fig.cap='Check box for Install and Restart', fig.align='center'}
...
```{r file-browser, echo=FALSE, fig.cap='Files are listed in the File browser', fig.align='center'}
...
```{r save-r-script, echo=FALSE, fig.cap='Saving a new R Script file called hello.R', fig.align='center'}
...
```{r empty-r-script, echo=FALSE, fig.cap='R Script file must be in the R/ sub-directory', fig.align='center'}
...
**Note**: in the function we do not actually plot any data. 
...
```{r build-pkg, echo=FALSE, fig.cap='Click the Build tab to install and restart', fig.align='center'}
...
```{r hello-pkg, echo=FALSE, fig.cap='Now you can load and use the hello() function', fig.align='center'}
...
```{r source-pkg, echo=FALSE, fig.cap='Build the source package', fig.align='center'}
...
```{r pkg-built, echo=FALSE, fig.cap='Source file is built (file ends in a .tar.gz)', fig.align='center'}
