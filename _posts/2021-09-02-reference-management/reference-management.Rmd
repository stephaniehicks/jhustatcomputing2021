...
1. [R Markdown from RStudio](https://rmarkdown.rstudio.com/authoring_bibliographies_and_citations.html)
2. [Reproducible Research in R](https://monashdatafluency.github.io/r-rep-res/citations.html) from the [Monash Data Fluency](https://monashdatafluency.github.io) initiative 
3. [R Markdown Cookbook](https://bookdown.org/yihui/rmarkdown-cookbook/bibliography.html)
...
```{r rmarkdown-wizards, echo = FALSE, fig.cap = "R Markdown magic [Artwork by Allison Horst]"}
