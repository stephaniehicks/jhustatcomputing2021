...
knitr::opts_chunk$set(echo = FALSE, comment = NA, prompt = TRUE, collapse = TRUE, tidy = FALSE)
...
1. [dplyr cheat sheet from RStudio](http://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf)
...
```{r dplyr, echo = FALSE, fig.cap = "Artwork by Allison Horst on the dplyr package", out.width = '60%', fig.align='center'}
...
```{r tidy-data, echo = FALSE, fig.cap = "Artwork by Allison Horst on tidy data"}
...
For the examples in this chapter we will be using a dataset containing air pollution and temperature data for the city of Chicago in the U.S. The dataset is available in this repository.     
...
```{r dplyr-mutate, echo = FALSE, fig.cap = "Artwork by Allison Horst on the mutate function"}
