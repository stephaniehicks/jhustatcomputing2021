...
knitr::opts_chunk$set(echo = TRUE, comment = NA, prompt = TRUE, collapse = TRUE, tidy = FALSE)
...
```{r groupby, echo = FALSE, fig.cap = "Artwork by Allison Horst on the filter function", out.width = '60%', fig.align='center'}
