...
```{r reticulate-completion, echo=FALSE, fig.cap='Using reticulate tab completion', out.width = '60%', fig.align='center'}
...
```{r repl-python, echo=FALSE, fig.cap='Using the repl_python() function', out.width = '60%', fig.align='center'}
