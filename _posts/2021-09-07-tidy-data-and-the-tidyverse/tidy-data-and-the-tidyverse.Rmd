...
In the code above, let's talk about what we did using the
`pivot_longer()` function. We will also talk about `pivot_wider()`. 
...
**Example**: Let's try another dataset. This data contain an excerpt of the [Gapminder data](https://cran.r-project.org/web/packages/gapminder/README.html#gapminder) on life expectancy, GDP per capita, and population by country.
