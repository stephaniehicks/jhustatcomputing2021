...
* Course time: Tuesdays and Thursdays from 1:30-2:50pm (**Eastern Daylight Time** time zone)
...
Dr. Hicks will hold office hours via Zoom at the following days/times:
...
In Fall 2021, we will have synchronous (online) lectures, but these will be recorded and posted online shortly afterwards.
...
* Project 0: September 2, 1:29pm (entirely optional and not graded but hopefully useful and fun)
...
expected that project assignments will be implemented and written up
...
3. Click on "Download R 4.1.0 for Windows"
