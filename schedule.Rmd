...
| | |  | | |
| Week 5 | Sept 28      | `r emojifont::emoji('package')` R package software development (build, doc)  | `r emojifont::emoji('headphones')` Data analysis | |
| | |  | | |
| | Sept 30      | `r emojifont::emoji('package')` R package software development (testing)  | | | 
