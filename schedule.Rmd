...
| | | | | |
| Week 6      | Oct 5   | `r emojifont::emoji('calendar')` Working with dates and times | | `r emojifont::emoji('palm_tree')` Project 3 [[html](projects/2021-10-05-project-3/index.html)] [[Rmd](https://github.com/stephaniehicks/jhustatcomputing2021/blob/main/_projects/2021-10-05-project-3/project-3.Rmd)]  |
| | | | | |
...
| | | | | |
| | Oct 14 | `r emojifont::emoji('snake')` Leveraging Python within R | `r emojifont::emoji('headphones')` R package dev | |
| | | | | |
