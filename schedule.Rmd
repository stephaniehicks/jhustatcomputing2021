...
| | | | | |
| | Sept 9 | `r emojifont::emoji('heart_eyes_cat')` Tidy data and the Tidyverse [[html](posts/2021-09-07-tidy-data-and-the-tidyverse/index.html)] [[Rmd](https://github.com/stephaniehicks/jhustatcomputing2021/blob/main/_posts/2021-09-07-tidy-data-and-the-tidyverse/tidy-data-and-the-tidyverse.Rmd)] | `r emojifont::emoji('headphones')` Data viz  | `r emojifont::emoji('fallen_leaf')`  Project 0 due |
...
| | | | | |
|   Week 3 | Sept 14  | `r emojifont::emoji('bar_chart')` The ggplot2 plotting system: qplot() [[html](posts/2021-09-09-ggplot2-plotting-systems-part-1/index.html)] [[Rmd](https://github.com/stephaniehicks/jhustatcomputing2021/blob/main/_posts/2021-09-09-ggplot2-plotting-systems-part-1/ggplot2-plotting-systems-part-1.Rmd)] |  | |
| | | `r emojifont::emoji('bar_chart')` The ggplot2 plotting system: ggplot() [[html](posts/2021-09-09-ggplot2-plotting-systems-part-2/index.html)] [[Rmd](https://github.com/stephaniehicks/jhustatcomputing2021/blob/main/_posts/2021-09-09-ggplot2-plotting-systems-part-2/ggplot2-plotting-systems-part-2.Rmd)] |  | |
| | | |  | |
| **Module 2** |    | **Data analysis in R** |  | |
| | | | | |
|      | Sept 16      | `r emojifont::emoji('nut_and_bolt')` R Nuts and Bolts | | `r emojifont::emoji('palm_tree')` Project 2 |
| | | `r emojifont::emoji('nut_and_bolt')` Control structures in R | | | 
| |  Sept 17 | | | `r emojifont::emoji('fallen_leaf')`  Project 1 due |
| | | | | |
| Week 4  | Sept 21 | `r emojifont::emoji('nut_and_bolt')` Scoping rules of R  | | |
| |  | `r emojifont::emoji('nut_and_bolt')` Loop functions  | | |
| |  | `r emojifont::emoji('nut_and_bolt')` Functions in R   | | |
| | | | | |
| | Sept 23      | `r emojifont::emoji('package')` R package software development (build, doc) | `r emojifont::emoji('headphones')` Data analysis  | | 
| | |  | | |
| Week 5 | Sept 28      | `r emojifont::emoji('package')` R package software development (testing) | `r emojifont::emoji('headphones')` Data analysis  | | 
| | |  | | |
| | Sept 30      | `r emojifont::emoji('bug')` Debugging code in R | | | 
...
| | | | | |
| Week 6      | Oct 5   | `r emojifont::emoji('calendar')` Working with dates and times | | `r emojifont::emoji('palm_tree')` Project 3  f|
| | | | | |
| | Oct 7 | `r emojifont::emoji('sparkles')` Regular expressions | | |
| | | | | |
| Week 7      | Oct 12        | `r emojifont::emoji('volcano')` Dealing with large data; parallel computing  | | |
| | | | | |
| | Oct 14 | `r emojifont::emoji('snake')` Leveraging Python within R | | |
| | | | | |
| **Module 3** |    | **Basic algorithms for optimization and estimation ** | |
| | | | | |
| Week 8      | Oct 19       | Basic statistical computing algorithms | |
| | | | | |
